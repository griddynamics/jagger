 ...
 *     - warmUpTimeInSeconds - Load will increase from 0 to @e transactionsPerSecond in this time
 *
...
public class JLoadProfileTps implements JLoadProfile {
    ...
    public static class Builder {
         ...
         * @param warmUpTimeInSeconds The warm up time value in seconds. Jagger increases load from 0 to @b transactionsPerSecond by @b warmUpTimeInSeconds
         */
